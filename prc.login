...
:'# 10-12-17 ejl isr 36184 add invr and type to parameters::
:'# ripped from issues/post::
:'# incoming parameter list looks like  (too many to fit in pm-pz):'  -r "+pid=12345+rec=22345+pri=4+clk=123+pwd=abc+hot=Y+invr=123132+type=RII"):
...
::declare extern invrnum,typeval:
...
:not schd:errmsg="Can't find record"<recnum; goto loginEr:
:schd(10)&schd(1) ne typeval&invrnum:errmsg="Error invr"<invrnum<"may have closed. reload page";goto loginEr:
::type=schd(10):
:typeval ne "":type=typeval:
...
::invrnum=mid(@pm,invloc+"5",typloc-(invloc+"5")):
::typeval=mid(@pm,typloc+"5","3"):
::return:
